        ...
        return {
            ...
            contents: [{
                ...
                elements: [
                        ...
                        children: [
                            {
                                ...
                                className: 'faSelect',
                                label: 'Size',
                                items: [['No'], ['fa-xs'], ['fa-sm'], ['fa-lg'], ['fa-2x'], ['fa-3x'], ['fa-5x']],
                                'default': 'No',
                            ...
                            },
                            {
                                ...
                                className: 'faSelect',
                                label: 'Rotat',
                                items: [['No'], ['fa-rotate-90'], ['fa-rotate-180'], ['fa-rotate-270'], ['fa-flip-horizontal'], ['fa-flip-vertical']],
                                'default': 'No',
                                commit: function (widget) {
                    ...
                    {type: 'html', html: '<div id="ckeditor-fa-icons">' + faIcons(faRegular, '') + '</div>'}
                ]
            }],
            onOk: function () {
                clear();
